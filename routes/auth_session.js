...
authSessionRouter.post("/login", (req, res) => {
  ...
  if (!email || !passowrd) return res.sendStatus(400);

  try {
    const { guid } = authByEmailPwd(email, passowrd);
...
//Solicitud de autenticada con sesion para obtener el perfil del usuario
